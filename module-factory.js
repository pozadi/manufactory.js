...
(function() {
  var BaseModule, DYNAMIC, GLOBAL, HTML_INSERTED, LAMBDA_MODULE, ModuleInfo, __moduleEvents, __moduleInstances, __modules, _emptyJQuery, _genLambdaName, _notOption, _removeFromArray, _splitToLines, _whitespace,
    __slice = [].slice,
