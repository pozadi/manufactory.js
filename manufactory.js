...
(function() {
  var BaseModule, DYNAMIC, GLOBAL, LAMBDA_MODULE, ModuleInfo, NEW_HTML, NEW_HTML_FEW, __moduleEvents, __moduleInstances, __modules, _genLambdaName, _notOption, _splitToLines, _whitespace,
    __slice = [].slice,
