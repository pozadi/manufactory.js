...
(function() {
  var BaseModule, DYNAMIC, GLOBAL, HTML_INSERTED, LAMBDA_MODULE, ModuleInfo, action, __moduleEvents, __moduleInstances, __modules, _emptyJQuery, _genLambdaName, _notOption, _removeFromArray, _splitToLines, _whitespace,
    __slice = [].slice,
  ...
  _.extend(jQuery.prototype, {
    ...
    htmlInserted: function() {
      return this.trigger(HTML_INSERTED);
    }
  });
