...
(function() {
  var BaseModule, DYNAMIC, GLOBAL, HTML_INSERTED, LAMBDA_MODULE, ModuleInfo, action, buildModule, genLambdaName, jqueryPlugins, lastNameId, modulesAPI, __moduleEvents, __moduleInstances, __modules,
    __slice = [].slice,
  ...
  BaseModule = (function() {
    ...
    function BaseModule(root, settings) {
      var data, option, _i, _len, _name, _ref,
        _this = this;
      this.root = root;
      ...
      __moduleInstances[_name = this.constructor.NAME] || (__moduleInstances[_name] = []);
  ...
  ModuleInfo = (function() {
    ...
    ModuleInfo.prototype.tree = function(treeString) {
      ...
      for (_i = 0, _len = lines.length; _i < _len; _i++) {
        ...
        options = _.map((options || '').split(/\s+/), $.trim);
        name = _.filter(options, function(l) {
          return !(l === DYNAMIC || l === GLOBAL);
        })[0] || null;
