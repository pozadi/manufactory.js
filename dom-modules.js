...
(function() {
  var BaseModule, DYNAMIC, HTML_INSERTED, LAMBDA_MODULE, ModuleInfo, action, buildModule, genLambdaName, jqueryPlugins, lastNameId, modulesAPI, __moduleEvents, __moduleInstances, __modules,
    __slice = [].slice,
