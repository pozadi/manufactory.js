...
(function() {
  var BaseModule, DYNAMIC, GLOBAL, HTML_INSERTED, LAMBDA_MODULE, ModuleInfo, action, __moduleEvents, __moduleInstances, __modules, _emptyJQuery, _genLambdaName, _notOption, _splitToLines, _whitespace,
    __slice = [].slice,
  ...
  window.modules = {
    ...
    init: function(moduleName, Module, context) {
      ...
      _ref = $(Module != null ? Module.ROOT_SELECTOR : void 0, context).add($(context).filter(Module != null ? Module.ROOT_SELECTOR : void 0));
      _results = [];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        el = _ref[_i];
